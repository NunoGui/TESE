...
# ── ÚNICA MUDANÇA REAL: features do nó Image vêm do PCA visual
...
image_features = visual_pca[visual_cols]
image_feat_dim = len(visual_cols)

print(f"  Users: {ratings['user'].nunique()} | Items: {ratings['item'].nunique()}")
print(f"  Features user: {user_feat_dim} | Features image (visual PCA): {image_feat_dim}")
...
mean_prec_s.to_csv(os.path.join(PASTA_OUTPUT, "precision_heterogatv2_visual.csv"), index=False)
mean_rec_s.to_csv(os.path.join(PASTA_OUTPUT,  "recall_heterogatv2_visual.csv"),    index=False)
mean_f1_s.to_csv(os.path.join(PASTA_OUTPUT,   "f1_heterogatv2_visual.csv"),       index=False)
mean_mrr_s.to_csv(os.path.join(PASTA_OUTPUT,  "mrr_heterogatv2_visual.csv"),      index=False)
...
fixed_metrics.to_csv(os.path.join(PASTA_OUTPUT, "fixed_metrics_heterogatv2_visual.csv"), index=False)
