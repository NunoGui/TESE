...
print(f"  Features demográficas: {user_feat_dim} | Features imagens: {image_feat_dim}")
 
# ──────────────────────────────────────────────
# 2. Função para construir HeteroData
# ──────────────────────────────────────────────
...
results_df.to_csv("../results/heterogat_tuning.csv", index=False)
with open("../results/hetero_gat_best_params.json", "w") as f:
